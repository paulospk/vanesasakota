...
const current: Entry[] = [
  {
    ...
    meta: "McCrory et al. · Psychoneuroendocrinology · 2023",
    body: "A large multi-cohort study pooling data across countries has now tested which stress biomarkers actually predict health outcomes, not just correlate with stress. The result: a slimmed-down, validated set of five markers that reliably predicts mortality risk, cutting through three decades of inconsistent methods for measuring 'wear and tear' on the body.",
    tag: "Stress biology · endocrine",
    href: "https://pubmed.ncbi.nlm.nih.gov/37100008/",
  },
  {
    title: "The HPA axis and emotional memory",
    meta: "Schwabe · Biological Psychiatry · 2025",
    body: "New research maps exactly how stress reshapes memory in four distinct ways: how it's formed, given context, retrieved, and how flexible it stays afterward. The same changes that help someone respond fast in a crisis can, when they don't switch off, become the rigid, intrusive memory patterns seen in trauma and anxiety.",
    tag: "Endocrine · stress · memory",
    href: "https://pubmed.ncbi.nlm.nih.gov/38880463/",
  },
  {
    title: "The brain–skin axis",
    meta: "Tan et al. · JAAD International · 2025",
    body: "A comprehensive 2025 review of 159 studies confirms the brain-skin connection runs in both directions. Stress hormones and nerve signals drive inflammation in conditions like eczema, psoriasis, and acne, while inflammatory molecules from the skin can cross back into the brain, feeding a cycle between skin flare-ups and mood.",
    tag: "Skin · nervous system · endocrine",
    href: "https://pmc.ncbi.nlm.nih.gov/articles/PMC12701686/",
  },
  {
    title: "Interoception and predictive processing",
    meta: "Greenwood & Garfinkel · Annual Review of Psychology · 2025",
    body: "A comprehensive 2025 review lays out how the brain's sensing of internal bodily signals directly shapes emotional experience. Conditions with very different presentations, anxiety, depression, PTSD, autism, all show distinct disruptions in this bodily sensing, pointing toward interoception-focused therapies as a shared treatment target.",
    tag: "Perception · prediction",
    href: "https://pubmed.ncbi.nlm.nih.gov/39423429/",
  },
  {
    title: "Relational neuroscience and co-regulation",
    meta: "Tottenham & Vannucci · Current Directions in Psychological Science · 2025",
    body: "New theoretical work proposes that early caregiving experiences become encoded as 'attachment schemas', patterns the brain uses to predict what relationships will feel like. These predictions actively shape emotional regulation throughout life, offering a mechanistic bridge between early relational experience and adult nervous system functioning.",
    tag: "Regulation · relationship",
    href: "https://pubmed.ncbi.nlm.nih.gov/40787155/",
  },
];
