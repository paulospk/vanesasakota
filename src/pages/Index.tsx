        ...
        <div className="max-w-[1100px] mx-auto px-5 md:px-8 py-10 md:py-20">
          <div className="grid grid-cols-1 lg:grid-cols-10 gap-8 lg:gap-8">
            ...
            <div className="lg:col-span-7 max-w-[680px] space-y-4 text-[15px] md:text-base leading-[1.75] text-muted-foreground">
              ...
              <p>
                Here my work centers around supporting individuals navigating the emotional roots and psychological load of <strong>psychosomatic</strong> and <strong>stress-sensitive conditions</strong>. This typically includes <strong>gastrointestinal and digestive difficulties</strong>, <strong>female pelvic pain</strong> (<strong>vulvodynia</strong> and <strong>vaginismus</strong>), and <strong>stress-responsive skin conditions</strong> (<strong>atopic dermatitis</strong>, <strong>psoriasis</strong>, <strong>chronic urticaria</strong>, and <strong>hyperhidrosis</strong>), as well as somatic symptoms like <strong>tension headaches</strong>, <strong>chronic fatigue</strong>, and <strong>nervous system depletion</strong>.
              </p>
