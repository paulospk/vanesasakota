  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-hero border-b border-border">
        <div className="max-w-[1200px] mx-auto px-5 md:px-8 pt-8 pb-4 md:py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-10 gap-8 lg:gap-16">
          ...
          <div className="lg:col-span-7 max-w-[800px]">
            <ul className="space-y-5 text-muted-foreground leading-relaxed">
              ...
              <li>
                <span className="font-semibold text-foreground">Approach:</span> Bridging top-down (CBT) and bottom-up (Brainspotting/Somatic) interventions.
              </li>
              <li>
