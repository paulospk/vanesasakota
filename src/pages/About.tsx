          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-14 items-center">
            <div className="space-y-4 md:space-y-5 animate-fade-up">
              ...
              <div className="space-y-4 text-muted-foreground text-[15px] md:text-base leading-[1.7]">
                ...
                <p>
                  With over a decade since undergraduate training, the Master of Psychology pathway was no longer straightforward - pursuing a <strong className="font-semibold text-foreground">Master of Psychotherapy and Counselling</strong> at <strong className="font-semibold text-foreground">Western Sydney University</strong> instead - completing in 2023. This was a rigorous, highly experiential program grounded in trauma-informed practice and the critical development of <em>the person of the therapist</em>.
                </p>
                <p>
