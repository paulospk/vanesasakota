          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-14 items-center">
            <div className="space-y-4 md:space-y-5 animate-fade-up">
              ...
              <div className="space-y-4 text-muted-foreground text-[15px] md:text-base leading-[1.7]">
                ...
                <p>
                  My work centers around supporting individuals navigating the emotional roots and psychological impact of living with somatic pain and stress-sensitive conditions. This includes chronic pain, female pelvic pain, vulvodynia and vaginismus, gastrointestinal difficulties (DBGI), and stress-responsive skin conditions such as psoriasis, eczema, atopic dermatitis, alopecia, vitiligo and hives.
                </p>
                <p>
