          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-14 items-center">
            <div className="space-y-4 md:space-y-5 animate-fade-up">
              ...
              <div className="space-y-4 text-muted-foreground text-[15px] md:text-base leading-[1.7]">
                ...
                <p>
                  With over a decade since her undergraduate training, the standard pathway into a Master of Psychology was no longer straightforward, so she chose a <strong className="font-semibold text-foreground">Master of Psychotherapy and Counselling</strong> at <strong className="font-semibold text-foreground">Western Sydney University</strong>, completing it in 2023. This was a rigorous, highly experiential program grounded in trauma-informed practice and the critical development of <em>the person of the therapist</em>. It proved to be an excellent choice, shaping the depth and range of clinical skill she brings to practice today.
                </p>
                <p>
